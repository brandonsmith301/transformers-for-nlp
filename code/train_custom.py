...
# --- custom model
from custom.transformer import *
from custom.utils import *
from custom.loader import *
...
# - Different Configs -------------------------------------------------------------#
"""
config_custom_attn_pooling, config_custom_concat_pooling, config_custom_gru_pooling, config_custom_lstm_pooling,
config_custom_mean_pooling, config_custom_weighted_pooling, config_custom_min_pooling, config_custom_max_pooling,
config_custom_mean_max_pooling, config_custom_gem_pooling
"""


@hydra.main(
    version_base=None,
    config_path="../conf/custom/",
    config_name="config_custom_gem_pooling",
)
